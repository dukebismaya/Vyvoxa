...
export default function FriendDiscovery({ onClose }) {
                ...
                <div className="mt-4 flex gap-2">
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                      // Handle message functionality here
                    }}
  ...
  return (
    ...
    >
      ...
      >
        <div className="p-6 border-b border-zinc-200 dark:border-zinc-700" onClick={(e) => e.stopPropagation()}>
          <div className="flex items-center justify-between">
          ...
          {/* Single Tabs root (removed duplicate root below) */}
          <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-4">
            ...
            <div className="overflow-y-auto max-h-[calc(90vh-140px)]" onClick={(e) => e.stopPropagation()}>
        ...
        {/* Content moved inside single Tabs root above */}
      </motion.div>
    </motion.div>
  );
}
